...
type PofpDetailQueryByIdResp struct {
	Pofp            *PofpInfo        `json:"pofp,omitempty"`
	PofpDynamicInfo *PofpDynamicInfo `json:"pofpDynamicInfo,omitempty"`
}
...
type PofpInfo struct {
	...
	CommentsCnt *int32             `json:"commentsCnt,omitempty"`
	Content     *string            `json:"content,omitempty"`
	CreatedAt   *time.Time         `json:"createdAt,omitempty"`
	LastMark    *time.Time         `json:"lastMark,omitempty"`
	LastView    *time.Time         `json:"lastView,omitempty"`
	LatLng      *PointCoord        `json:"latLng,omitempty"`
	LikesCnt    *int32             `json:"likesCnt,omitempty"`
	MarksCnt    *int32             `json:"marksCnt,omitempty"`
	Photos      *[]string          `json:"photos,omitempty"`
	Pid         *uint32            `json:"pid,omitempty"`
	PoiData     *map[string]string `json:"poiData,omitempty"`
	PoiId       *string            `json:"poiId,omitempty"`
	Title       *string            `json:"title,omitempty"`
	TypeId      *uint32            `json:"typeId,omitempty"`
	UpdatedAt   *time.Time         `json:"updatedAt,omitempty"`
	Uuid        *string            `json:"uuid,omitempty"`
	ViewsCnt    *int32             `json:"viewsCnt,omitempty"`
}

// PofpInteractionReq defines model for PofpInteractionReq.
type PofpInteractionReq struct {
	// IxnType 互动类型
	IxnType *int    `json:"ixnType,omitempty"`
	Uuid    *string `json:"uuid,omitempty"`
}
...
var swaggerSpec = []string{
	...
	"H4sIAAAAAAAC/9RYX28Txxb/KmjuffSNA1zdB7+RRFxFTZU0kPahiqKx99gesp4ZZmYTLGQpUFoIBBJV",
	"BcSfloSWNlVFAiItTWjJl8nazreoZncdr+3xejeJiXhBOHNm9pzfb86Zc35XUY6VOKNAlUSZq0jmilDC",
	"3n+HmEOtYcaEpX9xwTgIRcBbo6D//beAPMqgf6WbZ6SDA9ITjFDl766kkJxPYl9JIVXmgDKIZS9BTukT",
	"xlgOK8LoMCuVGL0AWOSKkyC5PrfDeNz734SjJgRIUqBTk2NDWOWK/wfV2NMaj7911PJ+EAUlGTpXKkFo",
	"ATW9wkLgsv7tCNsztEDmBOHaP5RBF8dHxlEq9jGmaCdAjdI863QUz2GFhfHULBGqOIIVmFcFgGVcyQnA",
	"CqxzSq/mmShhhTLIwgr+o0gJUKpzSwGoBaLF3iFUnT3TNCZUQQGEtiZWXEuKS2bvJYccMS853Erq/jyQ",
	"QrHVvptPEeRMQqGTe3djtbb4a/XNuvvN0t7uWvXaJkoZKRzBCnduz2IJ//vvKUsvppreZcsKpCmSBmBt",
	"TqzcdV8+7LQ3BsPyfAhL+MwBUR4qe0k/CZc7b15Wr3j+2/Z4HmW+jM7nUPWoTKfaHfx+pbp6s770lftk",
	"q5EQQfK1Gtb/eFPf3a69fuf+cIdY7q2H9bX1cGr15C9WshkhMJUJzvK8tUREl7Q897I4the6uAHtkvo5",
